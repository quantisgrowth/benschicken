...
export function ProductShowcase({ content }: { content?: SiteContent }) {
  const images = content?.images;

  const products = [
    {
      src: images?.productBucketImage ?? productBucket,
